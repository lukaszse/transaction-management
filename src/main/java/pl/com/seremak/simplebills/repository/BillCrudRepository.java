...
public interface BillCrudRepository extends ReactiveCrudRepository<Bill, String> {
    ...
    Mono<Bill> deleteByUserAndBillNumber(final String user, final Integer billNumber);

    Mono<Bill> findByUserAndBillNumber(final String user, final Integer billNumber);
